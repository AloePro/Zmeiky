    ...
    public class Snake
    {
        ...
        public void Move(Direction direction, bool eat = false)
        {
            ...
            Head = direction switch
            {
                ...
                Direction.Left => new Pixel(Head.X - 1, Head.Y, _bodyColor),
                Direction.Up => new Pixel(Head.X, Head.Y - 1, _bodyColor),
                Direction.Down => new Pixel(Head.X, Head.Y + 1, _bodyColor),
                _ => Head
            };
